...
const PRODUCTS = [
  { id: 'p1', title: 'Premium Dog Food', price: 3500, img: '../Assets/dogfood.png'},
  { id: 'p2', title: 'Organic Cat Food', price: 2500, img: '../Assets/catfood.png' },
  { id: 'p3', title: 'Bird Cage', price: 7210, img: '../Assets/birdCage.jpg' },
  { id: 'p4', title: 'Fish Food', price: 1602, img: '../Assets/fishfood.jpg' },
  { id: 'p5', title: 'Durable Dog Leash', price: 2500, img: '../Assets/dogleash.jpg' },
  { id: 'p6', title: 'Pet Toys', price: 1015, img: '../Assets/petToys.jpg' },
  { id: 'p7', title: 'Aquarium Starter Kit', price: 10995, img: '../Assets/aquarium.jpg' },
  { id: 'p8', title: 'Pet Bed', price: 3000, img: '../Assets/petbed.jpg' },
  { id: 'p9', title: 'Grooming Kit', price: 4987, img: '../Assets/groomingKit.jpg' },
  { id: 'p10', title: 'Collar with Name Tag', price: 1200, img: '../Assets/collar.jpeg' },
  { id: 'p11', title: 'Pet Carrier', price: 8000, img: '../Assets/petCarrier.jpg' },
  { id: 'p12', title: 'Hamster Cage', price: 1800, img: '../Assets/hamstercage.jpg' },
  { id: 'p13', title: 'Reptile Heat Lamp', price: 3503, img: '../Assets/heatlamp.jpg' },
  { id: 'p14', title: 'Pet Vitamins', price: 900, img: '../Assets/petvitamins.png' },
  { id: 'p15', title: 'Cozy Cat Bed', price: 5500, img: '../Assets/catBed.jpg' },
  { id: 'p16', title: 'Durable Dog Leash and Collar Set', price: 4000, img: '../Assets/collarSet.jpg' },
  { id: 'p17', title: 'Pet First Aid Kit', price: 3000, img: '../Assets/firstAid.jpg'},
  { id: 'p18', title: 'Rabbit Food', price: 2300, img: '../Assets/rabbitfood.png'},
  { id: 'p19', title: 'Fish Tank and Decorations', price: 15000, img: '../Assets/fishtankDecorations.jpg'},
];

/* Cart information is saved in (localStorage) */
function getCart(){
...
function renderProducts(){
  ...
  const shownProducts = isHome ? PRODUCTS.slice(1, 4) : PRODUCTS;

  shownProducts.forEach(p => {
    const card = document.createElement('div');
    card.className = 'product-card';
    card.innerHTML = `
      <img src="${p.img}" alt="${p.title}" class="product-img" onerror="this.src='../assets/placeholder.png'">
      <h3>${p.title}</h3>
